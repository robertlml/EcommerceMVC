...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito , Venta oVenta)
        {
            ...
            Checkout_Order oCheckutOrder = new Checkout_Order()
            {
                intent = "CAPTURE",
                ...
                application_context = new ApplicationContext()
                {
                    ...
                    user_action = "PAY_NOW",
                    return_url = "https://localhost:44350/Tienda/PagoEfectuado",
                    cancel_url = "https://localhost:44350/Tienda/Carrito"
            ...
            response_paypal = await opaypal.CrearSolicitud(oCheckutOrder);
